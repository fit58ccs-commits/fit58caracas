        ...
        <div className="glass-card p-6 rounded-2xl" style={{ gridColumn:"1 / -1" }}>
          ...
          <div className="grid gap-6" style={{ gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))" }}>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                <label className="block text-[9px] font-black text-neutral-400 tracking-[1.5px] uppercase mb-1">Texto principal</label>
                <input
                  value={draft.editorial?.taglineMain ?? "Nutre tu cuerpo"}
                  onChange={e => F("editorial", { ...draft.editorial, taglineMain: e.target.value })}
                  className="field-input w-full border border-neutral-200/80 px-3 py-2 text-sm bg-white/72 rounded-lg font-[inherit]"
                  placeholder="Nutre tu cuerpo"/>
              </div>

              <div>
                <label className="block text-[9px] font-black text-neutral-400 tracking-[1.5px] uppercase mb-1">Palabra en cursiva</label>
                <input
                  value={draft.editorial?.taglineEmphasis ?? "mejor"}
                  onChange={e => F("editorial", { ...draft.editorial, taglineEmphasis: e.target.value })}
                  className="field-input w-full border border-neutral-200/80 px-3 py-2 text-sm bg-white/72 rounded-lg font-[inherit]"
                  placeholder="mejor"/>
              </div>

              <div>
                <label className="block text-[9px] font-black text-neutral-400 tracking-[1.5px] uppercase mb-1">Texto final</label>
                <input
                  value={draft.editorial?.taglineEnd ?? "del mundo."}
                  onChange={e => F("editorial", { ...draft.editorial, taglineEnd: e.target.value })}
                  className="field-input w-full border border-neutral-200/80 px-3 py-2 text-sm bg-white/72 rounded-lg font-[inherit]"
                  placeholder="del mundo."/>
              </div>

              <div>
                <label className="block text-[9px] font-black text-neutral-400 tracking-[1.5px] uppercase mb-1">Descripcion (columna derecha)</label>
                <textarea rows={3}
                  value={draft.editorial?.taglineDesc ?? "En Fit +58 Caracas importamos los suplementos y productos gourmet que antes no conseguias."}
                  onChange={e => F("editorial", { ...draft.editorial, taglineDesc: e.target.value })}
              ...
              <div className="neumorph rounded-xl p-4 mt-1"
                ...
                <p className="font-black m-0 leading-snug"
                  style={{ color: draft.editorial?.taglineColor ?? "#0d0d0d", fontSize: draft.editorial?.taglineFontSize ?? 18, fontFamily: draft.editorial?.taglineFontFamily ?? "inherit" }}>
                  {draft.editorial?.taglineMain ?? "Nutre tu cuerpo"}<br/>
                  con lo <em className="font-normal italic">{draft.editorial?.taglineEmphasis ?? "mejor"}</em> {draft.editorial?.taglineEnd ?? "del mundo."}
                </p>
                <p className="text-[11px] m-0 mt-2 leading-relaxed"
                  style={{ color: draft.editorial?.taglineDescColor ?? "#585757" }}>
                  {draft.editorial?.taglineDesc ?? "Descripcion del negocio..."}
                </p>
              </div>
            </div>
